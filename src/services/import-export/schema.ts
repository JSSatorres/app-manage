...
export const ENTITY_SCHEMAS: Record<EntityKey, EntitySchema> = {
  ...
  ejercicios: {
    ...
    fields: [
      { key: "nombre", header: "Nombre", aliases: ["nombre", "name", "titulo"], type: "string", required: true },
      { key: "descripcion", header: "Descripción", aliases: ["descripcion", "description", "desc"], type: "string" },
      { key: "categoria", header: "Categoría", aliases: ["categoria", "category", "cat", "tipo"], type: "string" },
      { key: "objetivo", header: "Objetivo", aliases: ["objetivo", "objective", "goal", "finalidad"], type: "string" },
      { key: "duracionEstimada", header: "Duración (min)", aliases: ["duracionestimada", "duracion", "duration", "minutos", "mins"], type: "number" },
      { key: "material", header: "Material", aliases: ["material", "equipment", "recursos"], type: "string" },
